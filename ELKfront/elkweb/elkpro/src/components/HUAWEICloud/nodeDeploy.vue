    ...
    <div>
        <el-container>
            <el-main>
                ...
                <el-row>
                    <el-col :span="24" align="left" style="padding-left: 10%">
                        <!--上面的下拉框们-->
<!--                        节点：-->
...
<!--                        </el-select>-->
                        软件名：
                        <el-select id="group" v-model="softName_value" placeholder="请选择" align="left">
                                ...
                                <el-row>
                                    <el-col :span="24" align="center">
                                        <div class="table-wrapper">
                                            <!--下面的表格-->
                                            <el-table :data="tableData" :header-cell-style="{color: '#17caf0',fontSize:'16px'}" height="520">
