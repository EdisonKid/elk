                            ...
                            <el-col :span="24">
                                <div class="table-wrapper">
                                    <el-table :data="tableData"
                                              :header-cell-style="{color: '#17caf0',fontSize:'16px'}" height="520">
                                        <el-table-column prop="ERRORS_FROM" sortable label="时间"
                                                         align="center"></el-table-column>
                                        <el-table-column prop="ERROR" sortable label="故障信息"
                                                         align="center"></el-table-column>
                                        <el-table-column prop="HOST" sortable label="主机名"
                                                         align="center"></el-table-column>
                                    </el-table>
                                </div>
...
export default {
    ...
    methods: {
        ...
        getZAErrors() {//ZAHostsErrorMapper.xml - ELKZAErrorController.java
